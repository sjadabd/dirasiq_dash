<template>
  <VContainer class="py-10">
    ...
    <VCard class="pa-6">
      ...
      <h3 class="text-h6 mt-5">
        2. إنشاء الحساب واستخدام الخدمة
      </h3>
      <ul>
      ...
      <h3 class="text-h6 mt-5">
        4. المحتوى التعليمي ومحتوى المستخدم
      </h3>
      <ul>
      ...
      <p>
        ...
        <strong><a
          href="/privacy"
          target="_blank"
        >https://mulhimiq.com/privacy</a></strong>.
      </p>
      ...
      <ul>
        ...
        <li>
          لا نتحمل المسؤولية عن أي أضرار غير مباشرة أو عرضية أو تبعية ناتجة عن استخدامك للخدمة، بما في ذلك فقدان
          البيانات أو انقطاع الخدمة.
        </li>
      </ul>

      <h3 class="text-h6 mt-5">
        10. توفّر الخدمة والصيانة
      </h3>
      <p>
