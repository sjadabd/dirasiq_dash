  ...
  <VContainer class="py-10">
    ...
    <VCard class="pa-6">
      ...
      <ul>
        ...
        <li>
          بيانات الاستخدام والأجهزة: نوع الجهاز، إصدار النظام، معرفات الإشعارات، بيانات الأداء والأخطاء لتحسين الخدمة.
        </li>
        <li>محتوى يقدمه المستخدم اختياريًا: مثل الصورة الشخصية، الرسائل داخل التطبيق، أو الملفات المرفوعة.</li>
      </ul>

      <h3 class="text-h6 mt-5">
        2. مزودو الخدمات ومعالجو البيانات
      </h3>
      <p>
