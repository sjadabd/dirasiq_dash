...
export default {
  ...
  methods: {
    ...
    async fetchBookings() {
      ...
      try {
        this.persistState()
        if (!this.filters.study_year) { this.items = []; this.totalItems = 0 
...
<template>
  <div>
        ...
        >
          <VCardText>
            ...
            <VProgressLinear
              ...
              :color="capacityPct >= 90 ? 'error' : capacityPct >= 70 ? 'warning' : 'info'"
              height="6"
              rounded
              class="mt-2"
            />
        ...
        >
          <VCardText>
            <div class="d-flex align-center justify-space-between mb-2">
              ...
              <VChip
                size="small"
                :color="subscription.canAdd ? 'success' : 'error'"
                variant="flat"
              >
            ...
            <div class="text-h5 font-weight-bold text-success">
              {{ numberWithComma(subscription.remaining) }}
            </div>
            <div class="text-caption text-medium-emphasis">
              طلاب متبقين
            </div>
      ...
      <VCardText>
        ...
        <div class="d-flex flex-wrap ga-2 mb-3">
          <VChip
            ...
            :key="p.value ?? 'all'"
            :color="p.color"
            :variant="filters.status === p.value ? 'flat' : 'tonal'"
            :prepend-icon="p.icon"
          ...
          >
            {{ p.label }}
            <span
              v-if="p.value && pageCounts[p.value] > 0"
              class="ms-2 chip-count"
            >{{ pageCounts[p.value] }}</span>
          </VChip>
        </div>
        <VRow dense>
          <VCol
    ...
    <VRow v-else>
      ...
      >
        <VCard
          rounded="lg"
          elevation="0"
          class="booking-card h-100 d-flex flex-column"
        >
          <VCardText class="pb-2">
            ...
            <div class="course-strip pa-2 rounded mb-2">
              ...
              <div class="d-flex flex-wrap ga-1">
                ...
                <VChip
                  v-if="item.course?.hasReservation"
                  size="x-small"
                  color="warning"
                  variant="tonal"
            ...
            >
              ...
              <div class="text-body-2 message-box pa-2 rounded">
                {{ item.studentMessage }}
              </div>
            </div>
            <div
              v-if="item.teacherResponse"
              class="mb-2"
            >
              <div class="text-caption text-medium-emphasis mb-1">
                <VIcon
              ...
              <div class="text-body-2 response-box pa-2 rounded">
            ...
            >
              ...
              <div class="text-body-2 reject-box pa-2 rounded">
          ...
          <VCardActions class="pa-2 flex-wrap ga-1">
            <VBtn
              v-if="canPreApprove(item)"
              color="info"
              variant="tonal"
              size="small"
              prepend-icon="ri-thumb-up-line"
    ...
    >
      <VCard>
        ...
        <VCardActions>
          ...
          <VBtn
            variant="text"
            @click="preApproveDialog.open = false"
          >
            إلغاء
          </VBtn>
          <VBtn
            color="info"
            :loading="preApproveDialog.saving"
            prepend-icon="ri-thumb-up-line"
            @click="handlePreApprove"
          >
            موافقة أولية
          </VBtn>
        </VCardActions>
      ...
      <VCard>
        ...
        <VCardText>
          ...
          >
            ...
            <VAlert
              v-if="!consentDialog.reservationPaid"
              type="warning"
              variant="tonal"
              density="compact"
            >
        ...
        <VCardActions>
          ...
          <VBtn
            variant="text"
            @click="consentDialog.open = false"
          >
            إلغاء
          </VBtn>
          <VBtn
            color="success"
            :loading="consentDialog.saving"
    ...
    <VDialog
      v-model="updateResponseDialog.open"
      max-width="540"
    >
      <VCard>
        <VCardTitle class="d-flex align-center">
        ...
        <VCardActions>
          ...
          <VBtn
            variant="text"
            @click="updateResponseDialog.open = false"
          >
            إلغاء
          </VBtn>
          <VBtn
            color="warning"
            :loading="updateResponseDialog.saving"
            prepend-icon="ri-save-3-line"
            @click="handleUpdateResponse"
          >
            تحديث
          </VBtn>
        </VCardActions>
    ...
    <VDialog
      v-model="insufficientBalanceDialog.open"
      max-width="520"
    >
      <VCard>
        <VCardTitle class="d-flex align-center">
        ...
        <VCardActions>
          ...
          <VBtn
            variant="text"
            @click="insufficientBalanceDialog.open = false"
          >
            إغلاق
          </VBtn>
          <VBtn
