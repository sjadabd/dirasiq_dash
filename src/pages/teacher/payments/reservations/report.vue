    ...
    <VRow class="my-4">
      ...
      >
        ...
        >
          ...
          <div class="text-h5 mt-1">
            {{ numberWithComma(totals.totalAmount) }} د.ع
          </div>
        </VCard>
      </VCol>
      <VCol
      ...
      >
        ...
        >
          ...
          <div class="text-h5 mt-1">
            {{ numberWithComma(totals.totalPaidAmount) }} د.ع
          </div>
        </VCard>
      </VCol>
      <VCol
      ...
      >
        ...
        >
          ...
          <div class="text-h5 mt-1">
            {{ numberWithComma(totals.discountAmount) }} د.ع
          </div>
        </VCard>
      </VCol>
      <VCol
      ...
      >
        ...
        >
          ...
          <div class="text-h5 mt-1">
            {{ numberWithComma(totals.remainingAmount) }} د.ع
          </div>
        </VCard>
      </VCol>
    </VRow>
