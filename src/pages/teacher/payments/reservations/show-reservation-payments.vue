...
<template>
  <div class="reservation-page">
      ...
      >
        ...
        >
          <VCardItem>
            ...
            <div class="kpi-sub">
              {{ kpis.totalDiscount ? "خصومات مطبّقة" : "لا توجد خصومات" }}
            </div>
          </VCardItem>
        </VCard>
      </VCol>
        ...
        >
          ...
          >
            <VTextField
              ...
              @click:clear="applyClientFilters"
            />
          </VCol>
          <VCol
            cols="12"
    ...
    >
      ...
      <VCardItem>
        <SmartTable
          ...
          @show-item="goToDetails"
          @mark-reservation-paid-item="handleMarkReservationPaid"
        />
      </VCardItem>
    </VCard>
    ...
    <ConfirmDangerDialog
      ...
      :show-checkbox="true"
      checkbox-label="أفهم وأؤكد تسديد هذا العربون"
      confirm-icon="ri-money-dollar-box-line"
      confirm-icon-active="ri-check-double-line"
