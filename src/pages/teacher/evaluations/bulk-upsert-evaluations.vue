...
export default {
  ...
  methods: {
    ...
    async loadStudents() {
      if (!this.ready) { this.showAlert("info", "اختر التاريخ والكورس أولاً") 
    ...
    async saveAll() {
      if (!this.form.date) { this.showAlert("error", "التاريخ مطلوب") 

        return }
      if (!this.students.length) { this.showAlert("error", "لا يوجد طلاب لحفظهم") 
...
<template>
  <div>
    ...
    <VCard
      ...
      rounded="lg"
      elevation="0"
      class="border text-center pa-8 mb-4"
    >
      <VIcon
      ...
      <div class="text-h6 mb-2">
        اختر التاريخ والكورس
      </div>
      <div class="text-body-2 text-medium-emphasis">
        سيُجلب الطلاب تلقائياً بعد اختيار الكورس.
      </div>
    </VCard>
    ...
    >
      ...
      <div class="text-body-2 text-medium-emphasis">
        تأكد من تأكيد حجوزات الطلاب أولاً.
      </div>
    </VCard>
    ...
    <template v-else>
        ...
        <VCardText>
          ...
          <div class="d-flex flex-wrap align-center ga-2">
            ...
            <VBtn
              ...
              variant="tonal"
              size="small"
              @click="setAllStudents('excellent')"
            >
              ممتاز
            </VBtn>
            <VBtn
              ...
              variant="tonal"
              size="small"
              @click="setAllStudents('very_good')"
            >
              جيد جداً
            </VBtn>
            <VBtn
      ...
      <VCard
        rounded="lg"
        elevation="0"
        class="border mb-4 col-quickfill d-none d-lg-block"
      >
            ...
            >
              ...
              <div class="d-flex justify-center ga-1 flex-wrap">
                <VBtn
                  ...
                  variant="tonal"
                  min-width="44"
                  @click="setColumnAll(a.key, 'excellent')"
                >
                  ممتاز
                </VBtn>
                <VBtn
          ...
          <VCardText class="pa-3">
            ...
            <div class="d-flex align-center ga-3 mb-3 flex-wrap">
              <div class="d-flex align-center ga-3 flex-grow-1">
                <VAvatar
                  :color="scoreColor(rowAvgScore(s))"
                  size="40"
                >
              ...
              <div class="d-flex align-center ga-2 flex-wrap">
                <VChip
                  v-if="rowAvgScore(s) != null"
                  :color="scoreColor(rowAvgScore(s))"
                  variant="flat"
                  size="small"
                  prepend-icon="ri-trophy-line"
                >
                  {{ rowAvgScore(s) }}/10
                </VChip>
                <VBtn
                  v-for="p in ROW_PRESETS"
                  :key="p.label"
                  :color="p.color"
                  :variant="p.value === null ? 'text' : 'tonal'"
                  size="x-small"
                  @click="setRowAll(s, p.value)"
                >
                  {{ p.label }}
                </VBtn>
              </div>
              ...
              >
                <div class="axis-label">
                  <VIcon
                    :icon="a.icon"
                    size="14"
                    :color="ratingInfo(s[a.key])?.color || 'grey'"
                    class="me-1"
                  />
            ...
            >
              ...
              >
                <VTextField
                  v-model="s.guidance"
                  prepend-inner-icon="ri-lightbulb-line"
                  label="توجيه (اختياري)"
                  density="compact"
                  variant="outlined"
                  hide-details
      ...
      <div class="save-bar">
        <VCard
          rounded="lg"
          elevation="8"
          class="d-flex align-center pa-3 ga-2 flex-wrap"
        >
          <VIcon
          ...
          <VBtn
            color="primary"
            :loading="saving"
            :disabled="!isDirty || !completedCount"
