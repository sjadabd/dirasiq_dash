        ...
        <VRow class="mb-6">
          ...
          >
            ...
            >
              ...
              <div class="text-h6 font-weight-bold text-white">
                {{ numberWithComma(report?.totals?.totalAmount || 0) }} د.ع
              </div>
            </VCard>
          </VCol>
          <VCol
          ...
          >
            ...
            >
              ...
              <div class="text-h6 font-weight-bold text-white">
                {{ numberWithComma(report?.totals?.discountAmount || 0) }} د.ع
              </div>
            </VCard>
          </VCol>
          <VCol
          ...
          >
            ...
            >
              ...
              <div class="text-h6 font-weight-bold text-white">
                {{ numberWithComma(afterDiscount) }} د.ع
              </div>
            </VCard>
          </VCol>
          <VCol
          ...
          >
            ...
            >
              ...
              <div class="text-h6 font-weight-bold text-white">
                {{ numberWithComma(report?.totals?.totalPaidAmount || 0) }} د.ع
              </div>
            </VCard>
          </VCol>
          <VCol
          ...
          >
            ...
            >
              ...
              <div class="text-h6 font-weight-bold text-white">
                {{ numberWithComma(report?.totals?.remainingAmount || 0) }} د.ع
              </div>
            </VCard>
          </VCol>
        </VRow>
