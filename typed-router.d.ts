...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-account-deletions': RouteRecordInfo<'admin-account-deletions', '/admin/account-deletions', Record<never, never>, Record<never, never>>,
    ...
    'admin-video-courses': RouteRecordInfo<'admin-video-courses', '/admin/video-courses', Record<never, never>, Record<never, never>>,
    'admin-video-courses-id': RouteRecordInfo<'admin-video-courses-id', '/admin/video-courses/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-withdrawals': RouteRecordInfo<'admin-withdrawals', '/admin/withdrawals', Record<never, never>, Record<never, never>>,
    'apply-as-teacher': RouteRecordInfo<'apply-as-teacher', '/apply-as-teacher', Record<never, never>, Record<never, never>>,
    'apply-as-teacher-form': RouteRecordInfo<'apply-as-teacher-form', '/apply-as-teacher/form', Record<never, never>, Record<never, never>>,
    'apply-as-teacher-otp-id': RouteRecordInfo<'apply-as-teacher-otp-id', '/apply-as-teacher/otp/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apply-as-teacher-success': RouteRecordInfo<'apply-as-teacher-success', '/apply-as-teacher/success', Record<never, never>, Record<never, never>>,
    'chat-conversations': RouteRecordInfo<'chat-conversations', '/chat/conversations', Record<never, never>, Record<never, never>>,
    'chat-conversations-id': RouteRecordInfo<'chat-conversations-id', '/chat/conversations/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'chat-moderation-logs': RouteRecordInfo<'chat-moderation-logs', '/chat/moderation-logs', Record<never, never>, Record<never, never>>,
    'check-application-status': RouteRecordInfo<'check-application-status', '/check-application-status', Record<never, never>, Record<never, never>>,
    'contact': RouteRecordInfo<'contact', '/contact', Record<never, never>, Record<never, never>>,
    'delete-account': RouteRecordInfo<'delete-account', '/delete-account', Record<never, never>, Record<never, never>>,
    ...
    'teacher-payment-redirecting': RouteRecordInfo<'teacher-payment-redirecting', '/teacher/payment/redirecting', Record<never, never>, Record<never, never>>,
